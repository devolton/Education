...
import {OverviewItem} from "./settings/OverviewItem.tsx";
...
export function Overview() {
    ...
    useEffect(() => {
        setFullName(currentCustomUser.surname + " " + currentCustomUser.name + " " + currentCustomUser.middleName);
        ...
        <Content>
            <div className='card mb-5 mb-xl-10' id='kt_profile_details_view'>
                ...
                <div className='card-body p-9'>
                    <OverviewItem title={"Full name"} value={fullName}/>

                    <OverviewItem title={"Email"} value={currentCustomUser.email}/>
                    <OverviewItem title={"Login"} value={currentCustomUser.login}/>
                    {/*<OverviewItem title={"Created"} value={formattedDate}/>*/}
